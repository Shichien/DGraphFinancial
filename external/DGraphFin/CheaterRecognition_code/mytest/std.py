...
data_ones = data["x"].astype(np.float32) # 使用一个在 'data = np.load' 之后可用的变量
data_ones = np.ones(E, dtype=np.float32) # 修正：使用 'E'
...
print("Updated struct_feats with 200+ features (and new STD features):", struct_feats.shape)
